...
const PERSONAS = {
  daniel: {
    ...
    user: { member_no: "PT-884512", first_name: "Daniel", full_name: "Daniel Ferreira", email: "daniel.ferreira@consultmail.pt", phone: "+351 91 442 7781", tier: "Gold", miles: 48230, nationality: "Portuguese", doc_id: "PT •••• 3391", home_airport: "OPO", card_brand: "Visa", card_last4: "4417", card_exp: "08/28", card_product: "TAP | Miles&Go Visa Gold", card_categories: JSON.stringify([{ name: "Sports & Stadiums", share: 34 }, { name: "Sports Streaming", share: 18 }, { name: "Dining & Bars", share: 16 }, { name: "Rideshare", share: 12 }]), affinity: "football", affinity_label: "Football fan" },
  ...
  sofia: {
    ...
    user: { member_no: "PT-552037", first_name: "Sofia", full_name: "Sofia Marques", email: "sofia.marques@familymail.pt", phone: "+351 96 220 1184", tier: "Silver", miles: 21450, nationality: "Portuguese", doc_id: "PT •••• 7720", home_airport: "LIS", card_brand: "Mastercard", card_last4: "8852", card_exp: "05/27", card_product: "TAP | Miles&Go Mastercard", card_categories: JSON.stringify([{ name: "Golf & Country Clubs", share: 29 }, { name: "Sporting Goods", share: 21 }, { name: "Resorts & Spas", share: 17 }, { name: "Family Dining", share: 14 }]), affinity: "golf", affinity_label: "Golf enthusiast" },
...
function seedPersonaData(personaId) {
  ...
  const u = P.user;
  db.prepare(`INSERT INTO users (id,member_no,first_name,full_name,email,phone,tier,miles,nationality,doc_id,home_airport,card_brand,card_last4,card_exp,card_product,card_categories,affinity,affinity_label)
    VALUES (1,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`)
    .run(u.member_no, u.first_name, u.full_name, process.env.DEMO_EMAIL_TO || u.email, u.phone, u.tier, u.miles, u.nationality, u.doc_id, u.home_airport, u.card_brand, u.card_last4, u.card_exp, u.card_product, u.card_categories, u.affinity, u.affinity_label);
